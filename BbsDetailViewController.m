...
@synthesize nameString, titleString, dateString, contextString, parent_string, Bbs_string, Doc_ID, mtitle, status, htmlFile;
...
- (void)viewWillAppear:(BOOL)animated {
	...
	rCount.backgroundColor = [UIColor clearColor];
	...
	htmlFile = [[[child children] objectAtIndex:7] leafvalue];
	NSLog(files);
...
- (void) alertView:(UIAlertView *)alert clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex == 1) // "OK" 버튼
    {
		...
		eGMIF.xmlArg3 = parent_string;			// Doc_ID
